...
public class Alumno implements Serializable {
    ...
    public static ArrayList<Alumno> llenarAlumnos() {
        ...
        lst.add(new Alumno(33, R.drawable.perfil, "Braulio R", "2020030215","Ing. Tec. Informacion"));
        lst.add(new Alumno(34, R.drawable.perfil, "PRUEBA", "2020030215","Ing. Tec. Informacion"));
